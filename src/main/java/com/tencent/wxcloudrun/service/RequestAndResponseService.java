...
import com.tencent.wxcloudrun.util.MessageType;
import com.tencent.wxcloudrun.util.Music;
import com.tencent.wxcloudrun.util.NewsItem;
import com.tencent.wxcloudrun.util.Video;
...
public class RequestAndResponseService {
     ...
     * @return
     */
    String handleTextMessage(Map<String, String> map) {
        //响应消息
        String responseMessage;
        // 消息内容
        ...
        switch (content) {
            case "彩虹屁":
                String msgText = requestReplyMsgService.getChp();
...
//                break;
     ...
     * @return
     */
    String handleImageMessage(Map<String, String> map) {
     ...
     * @return
     */
    String handleVoiceMessage(Map<String, String> map) {
     ...
     * @return
     */
    String handleVideoMessage(Map<String, String> map) {
     ...
     * @return
     */
    String handleSmallVideoMessage(Map<String, String> map) {
        String thumbMediaId = map.get("ThumbMediaId");
        String mediaId = map.get("MediaId");
        System.out.print("thumbMediaId:" + thumbMediaId);
        System.out.print("mediaId:" + mediaId);
     ...
     * @return
     */
    String handleLocationMessage(Map<String, String> map) {
     ...
     * @return
     */
    String handleLinkMessage(Map<String, String> map) {
     ...
     * @return
     */
    String handleEventMessage(Map<String, String> map) {
     ...
     */
    String buildWelcomeTextMessage(Map<String, String> map) {
     ...
     * @return responseMessageXml
     */
    String buildWelcomeTextMessage(Map<String, String> map, String robotRes) {
        String responseMessageXml;
        String fromUserName = map.get("FromUserName");
        // 开发者微信号
        String toUserName = map.get("ToUserName");
        responseMessageXml = String
                .format(
                        "<xml>" +
                                ...
                                "</xml>",
                        //"感谢您关注我的个人公众号，请回复如下关键词来使用公众号提供的服务：\n博客园\n图片\n语音\n视频\n音乐\n图文"
                        fromUserName, toUserName, getMessageCreateTime(), robotRes);
        return responseMessageXml;
    }
     ...
     * @return 文本消息XML字符串
     */
    String buildTextMessage(Map<String, String> map, String content) {
        //发送方帐号
        String fromUserName = map.get("FromUserName");
        // 开发者微信号
        String toUserName = map.get("ToUserName");
     ...
     * @return 图片消息XML字符串
     */
    String buildImageMessage(Map<String, String> map, String mediaId) {
        //发送方帐号
        String fromUserName = map.get("FromUserName");
        // 开发者微信号
        String toUserName = map.get("ToUserName");
     ...
     * @return 音乐消息XML字符串
     */
    String buildMusicMessage(Map<String, String> map, Music music) {
        //发送方帐号
        String fromUserName = map.get("FromUserName");
        // 开发者微信号
        String toUserName = map.get("ToUserName");
     ...
     * @return 视频消息XML字符串
     */
    String buildVideoMessage(Map<String, String> map, Video video) {
        //发送方帐号
        String fromUserName = map.get("FromUserName");
        // 开发者微信号
        String toUserName = map.get("ToUserName");
     ...
     * @return 语音消息XML字符串
     */
    String buildVoiceMessage(Map<String, String> map, String mediaId) {
        //发送方帐号
        String fromUserName = map.get("FromUserName");
        // 开发者微信号
        String toUserName = map.get("ToUserName");
     ...
     * @return 图文消息XML字符串
     */
    String buildNewsMessage(Map<String, String> map) {
        String fromUserName = map.get("FromUserName");
        // 开发者微信号
        String toUserName = map.get("ToUserName");
     ...
     * @return
     */
    String buildSingleItem(NewsItem item) {
